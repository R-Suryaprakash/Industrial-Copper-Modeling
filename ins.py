...
st.set_page_config(page_title="Industrial copper",page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by SURYAPRAKASH.R'})
...
if selected == "About":
    ...
    st.markdown('''**Hello! I'm Suryaprakash, an mechanical graduate. I have an interest in data science and analytics.
